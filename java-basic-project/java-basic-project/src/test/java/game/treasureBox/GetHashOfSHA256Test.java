...
public class GetHashOfSHA256Test extends TestCase {
    ...
    public void test_verify_can_get_the_treasure_box_hash_value(){
        ...
        String lastHash="0";
        String mysteriousNum="243905556";
        GetTreasureBoxHash getTreasureBoxHash=new GetTreasureBoxHash();
        String result=getTreasureBoxHash.getBoxHash(boxSerialNum,mysteriousNum);
    ...
    public void test_get_mysterious_number(){
        ...
        String result=mysteriousNumber.mysteriousNumOfBox("1");
        String expected="88";
        mysteriousNumber.getALlMysteriousNum();
        assertEquals(expected,result);
    }
